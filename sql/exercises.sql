...
select staff_id, first_name, last_name, address_id, picture, email, store_id, picture, email, store_id, active, username, last_update 
from staff
...
from address where district in 
...
from film
where length < 120 and special_features 
like '%Behind the Scenes%' and rental_duration between 5 and 7
